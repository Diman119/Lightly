#ifndef lightlystyle_h
#define lightlystyle_h
...
namespace Lightly
{
    ...
    class Style: public ParentStyleClass
    {
        ...
        bool drawToolBarBackgroundControl( const QStyleOption*, QPainter*, const QWidget* ) const;
        ...
        */
        ...
        //* tabbar data
        LightlyPrivate::TabBarData* _tabBarData = nullptr;
